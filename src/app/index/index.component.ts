...
export class IndexComponent implements OnInit {
  ...
  tiles: Tile[] = [
    { text: 'First News', cols: 3, rows: 1, color: 'lightgrey' },
    { text: 'Second news', cols: 1, rows: 2, color: 'lightgrey' },
    { text: 'Third news', cols: 1, rows: 1, color: 'lightgrey' },
    { text: 'Fourth news', cols: 2, rows: 1, color: 'lightgrey' },
  ];
